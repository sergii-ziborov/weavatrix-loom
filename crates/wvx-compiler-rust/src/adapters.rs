...
pub fn crate_module(implementation_id: &str) -> Option<&'static str> {
    match implementation_id {
        ...
        "sonic-rs.parse@1" => Some("sonic_rs_parse"),
        ...
        "sha2.sha256-pair@1" => Some("sha2_sha256_pair"),
        ...
        "zlib-rs.gzip@1" => Some("zlib_rs_gzip"),
        "zlib-rs.gunzip@1" => Some("zlib_rs_gunzip"),
...
pub fn default_implementation(capability_key: &str) -> Option<&'static str> {
    match capability_key {
        ...
        "data.hash.sha256_pair@1" => Some("sha2.sha256-pair@1"),
...
pub fn built_in_sdk_emit(implementation_id: &str) -> Option<SdkEmit> {
    let (crate_name, crate_path, template) = match implementation_id {
        ...
        "sonic-rs.parse@1" => (
            "wvx-adapters",
            Some("crates/wvx-adapters"),
            "wvx_adapters::sonic_rs_parse::parse({bytes}.as_slice())?",
        ),
        "external.demo.json-parse@1" => (
        ...
        "sha2.sha256-pair@1" => (
            "wvx-adapters",
            Some("crates/wvx-adapters"),
            "wvx_adapters::sha2_sha256_pair::digest_hex({bytes}.as_slice())?",
        ),
        "sha2.sha256-streaming@1" => (
            "wvx-adapters",
            Some("crates/wvx-adapters"),
        ...
        "zlib-rs.gzip@1" => (
            "wvx-adapters",
            Some("crates/wvx-adapters"),
            "wvx_adapters::zlib_rs_gzip::compress({bytes}.as_slice())?",
        ),
        "zlib-rs.gunzip@1" => (
            "wvx-adapters",
            Some("crates/wvx-adapters"),
            "wvx_adapters::zlib_rs_gunzip::decompress({bytes}.as_slice())?",
        ),
        "wvx.reference.hex-encode@1" => (
            "wvx-adapters",
            Some("crates/wvx-adapters"),
