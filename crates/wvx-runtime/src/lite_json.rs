//! Independent recursive-descent JSON codec used as a second pilot implementation.
//!
//! Not a full RFC competitor to serde_json — enough for the pilot graph so
//! implementation swap is a real alternate code path, not a label change.
