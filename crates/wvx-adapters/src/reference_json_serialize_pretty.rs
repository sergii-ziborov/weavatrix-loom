//! Adapter: wvx.reference.json-serialize-pretty@1
use serde_json::Value;

pub fn serialize(value: &Value) -> Result<Vec<u8>, String> {
    // Reuse compact writer with pretty=true via duplicated logic kept local for a
    // self-contained generated crate (no path deps on loom runtime).
